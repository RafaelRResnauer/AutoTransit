...
setwd("~/Documentos/Facul/10º Período/TCC 2")
...
Dataset_PRF_2007 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2007")
Dataset_PRF_2008 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2008")
Dataset_PRF_2009 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2009")
Dataset_PRF_2010 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2010")
Dataset_PRF_2011 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2011")
Dataset_PRF_2012 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2012")
Dataset_PRF_2013 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2013")
Dataset_PRF_2014 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2014")
Dataset_PRF_2015 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2015")
Dataset_PRF_2016 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2016")
Dataset_PRF_2017 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2017")
Dataset_PRF_2018 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2018")
Dataset_PRF_2019 <- read_excel("~/Documentos/Facul/9º Período/TCC 1/Base/Policia Rodoviaria Federal/Dataset PRF 2007-2020.xlsx", sheet = "2019")
...
Dataset_PRF_all <- Dataset_PRF_all %>% select(-id) %>% as.matrix()

View(Dataset_PRF_all)


#Normalização das colunas da base de dados
#tirar acentuação e caracteres como ç para não dar problema com a decodificação do csv
...
write.csv(Dataset_PRF_all, file = "Dataset_PRF_1_0_csv_.csv", row.names = FALSE)
write.table(Dataset_PRF_all, file = 'Dataset_PRF_1_0_table_.csv', row.names = FALSE, col.names = TRUE, sep = ";", dec = "," )
