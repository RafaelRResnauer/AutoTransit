...
Dataset_PRF_all <- rbind(
  ...
  #Dataset_PRF_2011, Dataset_PRF_2012, Dataset_PRF_2013, Dataset_PRF_2014, Dataset_PRF_2015, 
  Dataset_PRF_2016, Dataset_PRF_2017, Dataset_PRF_2018, 
  Dataset_PRF_2019)
...
Dataset_PRF_2016_strings <- Dataset_PRF_all
View(Dataset_PRF_2016_strings)

X_2016_strings = subset(Dataset_PRF_2016_strings, select = -c(classificacao_acidente))
y_2016_strings <- Dataset_PRF_2016_strings[,'classificacao_acidente'];

write.table(Dataset_PRF_2016_strings, file = 'Dataset_PRF_2016_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(X_2016_strings, file = 'X_2016_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(y_2016_strings, file = 'y_2016_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
...
#Dataset_PRF_2016_numbers <- Dataset_PRF_all_numbers %>% select(-mortos, -feridos_leves, -feridos_graves, -ilesos, -ignorados, -feridos) %>% as.matrix()
#Dataset_PRF_2016_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -feridos_graves, -ignorados, -feridos) %>% as.matrix()
Dataset_PRF_2016_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -ignorados, -feridos) %>% as.matrix()
View(Dataset_PRF_2016_numbers)

X_2016_numbers = subset(Dataset_PRF_2016_numbers, select = -c(classificacao_acidente))
y_2016_numbers <- Dataset_PRF_2016_numbers[,'classificacao_acidente'];

write.table(Dataset_PRF_2016_numbers, file = 'Dataset_PRF_2016_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(X_2016_numbers, file = 'X_2016_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(y_2016_numbers, file = 'y_2016_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
