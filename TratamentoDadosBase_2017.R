...
#Dataset_PRF_2017_numbers <- Dataset_PRF_all_numbers %>% select(-mortos, -feridos_leves, -feridos_graves, -ilesos, -ignorados, -feridos) %>% as.matrix()
#Dataset_PRF_2017_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -feridos_graves, -ignorados, -feridos) %>% as.matrix()
Dataset_PRF_2017_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -ignorados, -feridos) %>% as.matrix()
