...
Dataset_PRF_2015_strings <- Dataset_PRF_all
View(Dataset_PRF_2015_strings)

X_2015_strings = subset(Dataset_PRF_2015_strings, select = -c(classificacao_acidente))
y_2015_strings <- Dataset_PRF_2015_strings[,'classificacao_acidente'];

write.table(Dataset_PRF_2015_strings, file = 'Dataset_PRF_2015_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(X_2015_strings, file = 'X_2015_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(y_2015_strings, file = 'y_2015_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
...
#Dataset_PRF_2015_numbers <- Dataset_PRF_all_numbers %>% select(-mortos, -feridos_leves, -feridos_graves, -ilesos, -ignorados, -feridos) %>% as.matrix()
#Dataset_PRF_2015_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -feridos_graves, -ignorados, -feridos) %>% as.matrix()
Dataset_PRF_2015_numbers <- Dataset_PRF_all_numbers %>% select(-feridos_leves, -ignorados, -feridos) %>% as.matrix()

View(Dataset_PRF_2015_numbers)

X_2015_numbers = subset(Dataset_PRF_2015_numbers, select = -c(classificacao_acidente))
y_2015_numbers <- Dataset_PRF_2015_numbers[,'classificacao_acidente'];

write.table(Dataset_PRF_2015_numbers, file = 'Dataset_PRF_2015_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(X_2015_numbers, file = 'X_2015_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
write.table(y_2015_numbers, file = 'y_2015_numbers.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
