...
Dataset_PRF_all <- rbind(
  ...
  Dataset_PRF_2015, Dataset_PRF_2016, Dataset_PRF_2017, Dataset_PRF_2018, Dataset_PRF_2019)
...
X_2015_strings = subset(Dataset_PRF_all, select = -c(classificacao_acidente))
y_2015_strings <- Dataset_PRF_all[,'classificacao_acidente'];

write.table(Dataset_PRF_all, file = 'Dataset_PRF_2015_strings.csv', row.names = FALSE, col.names = FALSE, sep = ",", dec = "." )
...
write.csv(Dataset_PRF_all, file = "Dataset_PRF_2015_csv_.csv", row.names = FALSE)
...
for(i in 1:nrow(Dataset_PRF_all)) {
  ...
  # Desobediencia da sinalizacao
  # Desobediencia das normas de transito pelo condutor
  # Desobediencia das normas de transito pelo pedestre
  # Falta de Atencao
  # Falta de Atencao do Condutor
