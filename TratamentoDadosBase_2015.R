...
write.table(Dataset_PRF_all, file = 'Dataset_PRF_2015_strings.csv', row.names = FALSE, col.names = TRUE, sep = ";", dec = "," )
write.table(X_2015_strings, file = 'X_2015_strings.csv', row.names = FALSE, col.names = TRUE, sep = ";", dec = "," )
write.table(y_2015_strings, file = 'y_2015_strings.csv', row.names = FALSE, col.names = TRUE, sep = ";", dec = "," )
